...
export const COMPANIONS: readonly CompanionDefinition[] = [
  ...
  { id: CompanionId.UnluckyMage, name: "Неудачный маг", description: "Сбрасывает случайную карту из руки — ваши постройки получают её имя/цвета/способность, но сохраняют свою цену. Дебафф!", emoji: "💫", passive: false },
