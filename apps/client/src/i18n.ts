...
const COMPANION_DESCRIPTIONS: Record<string, TranslationEntry> = {
  ...
  pyromancer: { en: "Plant 🔥 Flame in any player's hand AND your own. Flame is harmless on its own — clear it for 1💰 OR let 3 of them combine into 🔥 Fire (burns 1 card per turn, vanishes at end of day, or extinguish early for 3💰).", ru: "Подбрасывает 🔥 Пламя в руку любого игрока И себе. Само Пламя ничего не делает — потушите за 1💰 или дождитесь, пока 3 Пламени сольются в 🔥 Пожар (сжигает 1 карту/ход, исчезает в конце дня, можно потушить за 3💰).", id: "Tanam 🔥 Api di tangan pemain mana pun DAN tangan sendiri. Api sendiri tidak berbahaya — buang seharga 1💰 atau biarkan 3 menyatu jadi 🔥 Kebakaran (bakar 1 kartu/giliran, hilang di akhir hari, atau padamkan seharga 3💰)." },
