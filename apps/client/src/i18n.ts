...
const COMPANION_DESCRIPTIONS: Record<string, TranslationEntry> = {
  ...
  unlucky_mage: { en: "Discards a RANDOM hand card — your districts take its identity (name, colors, ability) but keep their own value", ru: "Сбрасывает СЛУЧАЙНУЮ карту из руки — ваши постройки получают её имя/цвета/способность, но сохраняют свою цену", id: "Buang kartu ACAK dari tangan — distrik Anda ambil identitasnya (nama/warna/kemampuan) tapi tetap nilai sendiri" },
