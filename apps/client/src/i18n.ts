...
const COMPANION_DESCRIPTIONS: Record<string, TranslationEntry> = {
  ...
  treasure_trader: { en: "2💰: sell you a Purple Card! placeholder (you'll pick from your own deck-build pool). {kw:leaves}", ru: "За 2💰: продаёт вам «Фиолетовую карту!» в руку (вы выбираете из своего деккилда). {kw:leaves}", id: "2💰: jual Kartu Ungu! placeholder (Anda memilih dari pool deck-build sendiri). {kw:leaves}" },
